// PDF BUILDER — Atelier A2: Anleitung am Computer (Sie-Imperativ)
(function () {
    ...
    function buildCast() {
        return `<div class="cast-banner">
            ...
            <div class="cast-grid">
                <div class="cast-card"><img src="images/annette.png" alt="Annette"><div class="name">Annette</div><div class="detail">Dă instrucțiuni</div></div>
                <div class="cast-card"><img src="images/acar.png" alt="Acar"><div class="name">Acar</div><div class="detail">Urmează pașii</div></div>
                <div class="cast-card"><img src="images/andreea.png" alt="Andreea"><div class="name">Andreea 🇷🇴</div><div class="detail">Notează tot</div></div>
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Anleitung am Computer (Sie-Imperativ)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillPromptBlock('Übung 1 — Sie-Imperativ (Verb + Sie)', 'Iei forma „Sie" de la prezent și pui verbul în față: Sie klicken → Klicken Sie!', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += fillPromptBlock('Übung 2 — Imperativ cu verbe separabile', 'Verbul + Sie e la început; prefixul (ein-/aus-/herunter-) zboară la finalul comenzii.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += choiceBlock('Übung 3 — Imperativul Sie corect', 'Alege forma de imperativ Sie corectă.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillPromptBlock('Übung 4 — du-Imperativ', 'du: fără -st; verbele tari e→i/ie păstrează schimbarea (Gib! Nimm! Lies!).', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += translateBlock('Übung 5 — Traducere RO → DE', 'Folosește imperativul Sie (sau du). Prefixul separabil la final.', ex5Data);
        }
        return html;
    }
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 4. Verbele — Präsens · Präteritum · Perfekt (+ Imperativ în Notă)</h1>
            <div class="andreea-note">
                <div class="andreea-note-content">
                    <div class="speaker">📌 Andreea îți spune:</div>
                    <div>Imperativul Sie = ca infinitivul (Klicken Sie!, Warten Sie!). La du, verbele tari e→i păstrează schimbarea: Gib! Nimm! Iar sein e special: Seien Sie!</div>
                </div>
            </div>`;
