// ============================================
// TEST FINAL - Atelier A2: Anleitung am Computer (Sie-Imperativ)
// Claudia Toth · 15 întrebări (Sie-Imperativ + separabile + du-Imperativ + traducere)
// ============================================

const finalTestData = [
    // 🖱️ Sie-Imperativ (5)
    { type: 'multiple', category: '🖱️ Sie-Imperativ', question: 'Imperativul Sie de la „kommen" este:', options: ['Kommen Sie!', 'Sie kommen.', 'Kommt!', 'Komm!'], correct: 'Kommen Sie!', explanation: 'Sie-Imperativ = verbul în față + Sie: Kommen Sie!' },
    { type: 'luckentext', category: '🖱️ Sie-Imperativ', question: 'Completează (warten, politicos):', sentence: '<strong>______</strong> Sie bitte einen Moment.', translation: 'imperativ Sie de la warten', accept: ['warten'], correct: 'Warten', explanation: 'Warten Sie bitte einen Moment.' },
    { type: 'multiple', category: '🖱️ Sie-Imperativ', question: 'Cum faci o comandă mai politicoasă?', options: ['cu „bitte"', 'cu „nicht"', 'cu „sehr"', 'cu „auch"'], correct: 'cu „bitte"', explanation: 'bitte înmoaie comanda: Warten Sie bitte.' },
    { type: 'luckentext', category: '🖱️ Sie-Imperativ', question: 'Completează (geben):', sentence: '<strong>______</strong> Sie das Passwort ein.', translation: 'imperativ Sie de la geben', accept: ['geben'], correct: 'Geben', explanation: 'Geben Sie das Passwort ein.' },
    { type: 'multiple', category: '🖱️ Sie-Imperativ', question: 'Imperativul Sie de la „sein" (Fiți calm!):', options: ['Seien Sie ruhig!', 'Sind Sie ruhig!', 'Seid ruhig!', 'Sei ruhig!'], correct: 'Seien Sie ruhig!', explanation: 'sein are imperativ Sie neregulat: Seien Sie!' },

    // 🔌 Separabile (3)
    { type: 'luckentext', category: '🔌 Separabile', question: 'Pune prefixul la final (einschalten):', sentence: 'Schalten Sie den Computer <strong>______</strong>.', translation: 'prefixul separabil', accept: ['ein'], correct: 'ein', explanation: 'einschalten → Schalten Sie … ein.' },
    { type: 'luckentext', category: '🔌 Separabile', question: 'Pune prefixul la final (herunterladen):', sentence: 'Laden Sie die Datei <strong>______</strong>.', translation: 'prefixul separabil', accept: ['herunter'], correct: 'herunter', explanation: 'herunterladen → Laden Sie … herunter.' },
    { type: 'multiple', category: '🔌 Separabile', question: 'Care comandă e corectă?', options: ['Schalten Sie den PC ein!', 'Einschalten Sie den PC!', 'Sie schalten den PC ein!', 'Schalten ein Sie den PC!'], correct: 'Schalten Sie den PC ein!', explanation: 'Verb + Sie + … + prefixul (ein) la final.' },

    // 👋 du-Imperativ (3)
    { type: 'multiple', category: '👋 du-Imperativ', question: 'du-Imperativ de la „geben":', options: ['Gib!', 'Geb!', 'Gibst!', 'Gebe!'], correct: 'Gib!', explanation: 'geben e tare (e→i): du gibst → Gib!' },
    { type: 'multiple', category: '👋 du-Imperativ', question: 'du-Imperativ de la „nehmen":', options: ['Nimm!', 'Nehm!', 'Nimmst!', 'Nehme!'], correct: 'Nimm!', explanation: 'nehmen e tare (e→i): du nimmst → Nimm!' },
    { type: 'luckentext', category: '👋 du-Imperativ', question: 'Completează (sein, du):', sentence: '<strong>______</strong> nicht nervös!', translation: 'du-Imperativ de la sein', accept: ['sei'], correct: 'Sei', explanation: 'sein → du-Imperativ: Sei! (Sei nicht nervös!)' },

    // 🗣️ Traducere (4)
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Faceți clic pe OK.', accept: ['klicken sie auf ok'], correct: 'Klicken Sie auf OK.', explanation: 'Klicken Sie + auf + OK.' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Porniți computerul.', accept: ['schalten sie den computer ein'], correct: 'Schalten Sie den Computer ein.', explanation: 'einschalten → prefixul ein la final.' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Așteptați, vă rog.', accept: ['warten sie bitte'], correct: 'Warten Sie bitte.', explanation: 'Warten Sie + bitte.' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Luați loc.', accept: ['nehmen sie platz'], correct: 'Nehmen Sie Platz.', explanation: 'Nehmen Sie Platz (a lua loc).' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong> despre imperativ (instrucțiuni).</p>
            <ul class="test-info-list">
                <li>🖱️ Sie-Imperativ (5) · 🔌 separabile (3) · 👋 du-Imperativ (3) · 🗣️ Traducere (4)</li>
